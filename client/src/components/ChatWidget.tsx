    ...
    <div className="fixed bottom-6 right-6 z-50">
      {isOpen ? (
        ...
        <button
          ...
          className="flex h-16 w-16 items-center justify-center rounded-full bg-primary-600 text-white shadow-xl shadow-primary-600/30 transition hover:scale-105 hover:bg-primary-700"
        >
