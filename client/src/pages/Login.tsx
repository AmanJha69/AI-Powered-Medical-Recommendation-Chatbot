          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/20 bg-white/70 p-8 shadow-2xl backdrop-blur-xl dark:border-slate-800/50 dark:bg-slate-900/70">
            <div className="mb-8 text-center">
              ...
              <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">
                Welcome to <span className="bg-gradient-to-r from-primary-600 to-cyan-500 bg-clip-text text-transparent">Dr. G</span>
              </h1>
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                Sign in to continue to your healthcare assistant
              </p>
            </div>
            ...
            <div className="mt-8 text-center text-sm">
              ...
              <Link to="/register" className="font-bold text-primary-600 transition hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
                Register now
              </Link>
            </div>
          </div>
